...
CRYPTO = [
    dict(id="PLS", name="PulseChain — PLS (WPLS/DAI)", network="pulsechain", search="WPLS", quotes=["DAI", "USDC", "USDT", "WETH", "pDAI"],
         ...
         deep=("pulsex", dict(token="WPLS", quote="DAI"))),
    dict(id="PLSX", name="PulseX — PLSX", network="pulsechain", search="PLSX", quotes=["WPLS", "DAI", "USDC"],
         token="0x95b303987a60c71504d99aa1b13b4da07b0790ab", deep=("pulsex", dict(token="PLSX", quote="WPLS"))),
    dict(id="pHEX", name="HEX on PulseChain (pHEX)", network="pulsechain", search="HEX", quotes=["WPLS", "DAI", "USDC"],
         token="0x2b591e99afe9f32eaa6214f7b7629768c40eeb39", deep=("pulsex", dict(token="PHEX", quote="WPLS"))),
    ...
    dict(id="INC", name="Incentive — INC", network="pulsechain", search="INC", quotes=["WPLS", "DAI", "PLSX"],
         token="0x2fa878ab3f87cc1c9737fc071108f904c0b0c95d", deep=("pulsex", dict(token="INC", quote="WPLS"))),
    dict(id="pDAI", name="pDAI — the forked DAI on PulseChain", network="pulsechain", search="DAI", quotes=["WPLS"],
         token="0x6b175474e89094c44da98b954eedeac495271d0f", deep=("pulsex", dict(token="PDAI", quote="WPLS"))),
    dict(id="PLSETH", name="PLS priced in ETH (WPLS/WETH)", network="pulsechain", search="WPLS", quotes=["WETH"],
         token="0xa1077a294dde1b09bb078844df40758a5d0f9a27", pool="0x42abdfdb63f3282033c766e72cc4810738571609", currency="token", units="ETH",
         deep=("pulsex", dict(token="WPLS", quote="WETH", in_usd=False))),
