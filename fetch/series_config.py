...
CRYPTO = [
    ...
    dict(id="PLSETH", name="PLS priced in ETH (WPLS/WETH)", network="pulsechain", search="WPLS", quotes=["WETH"], quote_sym="WETH",
         token="0xa1077a294dde1b09bb078844df40758a5d0f9a27", currency="token", units="ETH",
