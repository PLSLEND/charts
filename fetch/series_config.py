...
SERIES = [
    ...
    dict(id="GOLD", name="Gold (COMEX front-month; LBMA PM fix before 2000)", group="Indices & commodities", freq="D", kind="ohlc", units="USD/oz",
         tv="—", sources=[("yahoo", "GC=F"), ("stooq", "xauusd")], deep=("fred", "GOLDPMGBD228NLBM")),
